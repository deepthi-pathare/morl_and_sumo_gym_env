...
from morl_baselines.common.experiments_mod import (
    ALGOS,
    ENVS_WITH_KNOWN_PARETO_FRONT,
    StoreDict,
)

from morl_baselines.single_policy.ser.mo_ppo_discrete import make_env
...
def main():
    ...
    if args.algo == "pgmorl":
        ...
        if args.algo == "gpi_ls_discrete":
            ...
            env = mo_gym.wrappers.vector.MOSyncVectorEnv([make_env(args.env_id, seed=42, idx=1, run_name="training_gpilsppo", gamma=args.gamma)])
