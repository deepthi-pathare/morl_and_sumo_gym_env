...
from morl_baselines.common.weights import extrema_weights, random_weights
...
class LinearSupport:
    ...
    def __init__(
        ...
        #for w in random_weights(self.num_objectives, self.num_objectives):
    ...
    def next_weight(
        ...
        if len(self.ccs) > 0:
            ...
            #print("---compute_corner_weights: %s seconds --- \n\n" % (time.time() - start_time))
    ...
    def compute_corner_weights(self) -> List[np.ndarray]:
        ...
        #print("---compute_poly_vertices: %s seconds --- \n\n" % (time.time() - start_time))
