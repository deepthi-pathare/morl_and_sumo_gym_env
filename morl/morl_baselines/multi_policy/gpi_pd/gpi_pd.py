...
class GPIPD(MOPolicy, MOAgent):
    ...
    def train(
        ...
        for iter in range(1, max_iter + 1):
            ...
            #print("--- Optimization duration: %s seconds --- \n\n" % (time.time() - start_time_opt))
            ...
            if self.log and self.global_step % eval_mo_freq == 0:
                ...
                print("--- log duration: %s seconds --- \n\n" % (time.time() - start_time_log))
            """
            if checkpoints:
