...
sim_params['max_steps'] = 200   # Maximum number of RL steps per episode
sim_params['init_steps'] = 4 #int(4 * (sim_params['long_control_duration']/sim_params['sim_step_length'])) # Initial SUMO simulation steps before episode starts. At least one to get sumo subscriptions right.
...
# Traffic parameters
sim_params['traffic_density'] = 0.04 #vehicles per m
sim_params['road_length'] = 5000 #m
sim_params['moving_window_size'] = 400 #m
sim_params['spawning_safe_dist'] = 50 #m

# Heterogenious vehicle ratios
sim_params['hvr_trucks'] = 0.2
sim_params['hvr_cars'] = 0.8

# Speed distributions
sim_params['speed_mean_cars'] = 23
sim_params['speed_std_cars'] = 3.8
sim_params['speed_mean_trucks'] = 20
sim_params['speed_std_trucks'] = 0.8

# Reward parameters
sim_params['collision_penalty'] = 1000 #euros
sim_params['near_collision_penalty'] = 1000 #euros
sim_params['outside_road_penalty'] = 1000 #euros
sim_params['lane_change_penalty'] = 0.1 #not used in TCOP reward
sim_params['completion_reward'] = 4.41 #euros
sim_params['electricity_cost'] = 0.5 #euros per kwh
sim_params['driver_cost'] = 50 #euros per hour
...
vehicles[0]['guiShape'] = 'truck/semitrailer'
vehicles[0]['mass'] = 44000
vehicles[0]['length'] = 16.5   # default 16.5
vehicles[0]['width'] = 2.55   # default 2.55
vehicles[0]['maxSpeed'] = 25
...
vehicles[0]['accel'] = 0.1   # default 1.1.
vehicles[0]['decel'] = 6   # default 4.0.
vehicles[0]['emergencyDecel'] = 9.0   # default 4.0
vehicles[0]['sigma'] = 0.0   # default 0.5. Driver imperfection (0 = perfect driver)
vehicles[0]['tau'] = 1.0   # default 1.0. Time headway to leading vehicle. #https://sumo.dlr.de/docs/Car-Following-Models.html#tau
...
vehicles[1]['actionStepLength'] = 0.1   # decision interval
...
road_params['nodes'] = np.array([[0., 0.], [400., 0.], [sim_params['road_length'] - 2000.0, 0.], [sim_params['road_length'], 0.]])    # Road nodes
road_params['edges'] = ['start', 'highway', 'exit']
...
road_params['zoom'] = 1300
road_params['view_delay'] = 200
road_params['info_pos'] = [0, 70]
