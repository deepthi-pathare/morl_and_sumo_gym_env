...
from morl_baselines.single_policy.ser.mo_ppo_discrete import MOPPONet, MOPPO
...
class GPIPD(MOPolicy, MOAgent):
    ...
    def train(
        ...
        print("Training iterations - outer_iter(no of weights), inner_iter(for each weight), max_iter(total):", outer_iter, inner_iter, max_iter)
        ...
        for iter in range(1, outer_iter + 1):
            ...
            if self.log and iter % eval_iter_freq == 0:
                ...
                gpi_returns_test_tasks = [
                    ...
                    #policy_evaluation_mo(self, eval_env, ew, rep=num_eval_episodes_for_front)[3] for ew in eval_weights #TODO logging disc return
                ]
